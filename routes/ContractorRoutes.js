...
import DocumentController from '../controllers/contractor/DocumentController.js';
...
// Document Routes
router.post('/documents', uploadSingle('document'), DocumentController.uploadDocument);
router.get('/documents', DocumentController.getContractorDocuments);
router.delete('/documents/:documentId', DocumentController.deleteDocument);
router.get('/verification-status', DocumentController.getVerificationStatus);
...
router.post('/jobs/:jobId/accept-offer', JobController.acceptOffer);
...
router.post('/jobs/:jobId/quotes', quoteLimiter, uploadMultiple('documents', 5), JobController.submitQuote);
...
router.get('/payments/commissions', validatePagination, PaymentController.getCommissionDetails);
...
router.put('/meetings/:meetingId/status', MeetingController.updateMeetingStatus);
